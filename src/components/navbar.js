...
export default function Navbar() {
  ...
  const structuredLinks = [
    ...
    },
    {
      ...
      href: "/GlacierMatters",
      sublinks: [
        { label: "Crisis", href: "/GlacierMatters#cryosphere-crisis" },
        { label: "Our Approach", href: "/GlacierMatters#strategic-gaps" },
        { label: "Vision", href: "/GlacierMatters#dual-force-model" },
        { label: "North Star", href: "/GlacierMatters#solution-pillars" },
        { label: "Core Values", href: "/GlacierMatters#theory-of-change" },
        { label: "The Gaps", href: "/GlacierMatters#strategic-roadmap" },
      ],
    },
    {
      name: "Our Strategy",
